...
export default function ProductForm({ onSubmit, onCancel, initialData = {}, isEditing = false }) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden animate-in slide-in-from-bottom duration-300">
      <div className="bg-gray-50 p-4 border-b border-gray-100 flex justify-between items-center">
        <h2 className="font-bold text-gray-700">{isEditing ? 'Editar Produto' : 'Validar Produto'}</h2>
      ...
      <form onSubmit={handleSubmit} className="p-4 flex flex-col gap-4">
        ...
        >
          <Check size={20} />
          {isEditing ? 'Salvar Alterações' : 'Confirmar e Salvar'}
        </button>
      </form>
    </div>
  );
